...
SECRET_KEY = env(
    "SECRET_KEY", default="{{django_secret_key}}"
)
...
EMAIL_ADDRESS_MEMBER_OFFICE = "mitglied@{{domain}}"
EMAIL_ADDRESS_ACCOUNTING = "accounting@{{domain}}"
EMAIL_ADDRESS_MANAGEMENT = "contact@{{domain}}"
EMAIL_ADDRESS_SUPERVISORS = "aufsichtsrat@{{domain}}"
...
LDAP_WELCOME_DESK_ID = "CN=welcome-desk.members.{{domain}},O=SuperCoop Berlin eG,C=DE"
CLIENT_PERMISSIONS = {
...
SITE_URL = env("SITE_URL", default="https://{{domain}}")
